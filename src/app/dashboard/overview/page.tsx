...
//   //     router.replace('dashboard/unauthorize');
//   //   }
...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: cashRegisters.filter((c) => c.isActive).length,
      icon: CreditCard,
      color: 'text-primary',
    ...
    },
    {
      ...
      value: cashRegisters.filter((c) => c.currentSession?.status === 'open').length,
      icon: ShoppingCart,
              ...
              {products.slice(0, 5).map((product) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{product.price} XAF</p>
                  </div>
              ...
              {cashRegisters.map((register) => (
                ...
                >
                  ...
                  <div className="flex mt-2 sm:mt-0 items-center space-x-2">
                    ...
                    >
                      {register.currentSession?.status === 'open' ? 'Ouverte' : 'Fermée'}
                    </span>
                  </div>
                </div>
              ))}
